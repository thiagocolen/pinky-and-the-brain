...
5. **Save and offer delivery in one breath.** `save_article` writes `./articles/<slug>.md`, and
   ...
   change.
6. **Deliver.** Step 4c offers the blog, a folder, or neither. Choosing the blog publishes
